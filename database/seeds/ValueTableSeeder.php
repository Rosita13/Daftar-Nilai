...
class ValueTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $value = [
            ...
            ['id' => 5, 'siswa_id'=> '1234567','type' => 'UTS5','status' => 'remidi','nilai'=>80, 'semester'=>1, 'mapel_id'=> '1','class_id'=> '1', 'created_at' => \Carbon\Carbon::now()],
            ['id' => 6, 'siswa_id'=> '1234567','type' => 'UTS6', 'status'=> 'remidi','nilai'=>80, 'semester'=>1, 'mapel_id'=> '1','class_id'=> '1', 'created_at' => \Carbon\Carbon::now()],
        ];
